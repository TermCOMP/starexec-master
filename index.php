...
2020 => [
	...
	"mcats" => [
		"Termination of Rewriting" => [
			[ 'TRS Standard', 'termination', 41190 ],
			[ 'TRS Standard Certified', 'termination',  ],
			[ 'SRS Standard', 'termination', 41192 ],
			[ 'SRS Standard Certified', 'termination',  ],
			[ 'TRS Relative', 'termination', 41191 ],
			[ 'TRS Relative Certified', 'termination',  ],
			[ 'SRS Relative', 'termination', 41193 ],
			[ 'SRS Relative Certified', 'termination',  ],
			[ 'TRS Equational', 'termination', 41196 ],
			[ 'TRS Equational Certified', 'termination',  ],
			[ 'TRS Conditional', 'termination', 41194 ],
			[ 'TRS Context Sensitive', 'termination', 41195 ],
			[ 'TRS Innermost', 'termination', 41197 ],
			[ 'HRS (union beta)', 'termination', 41198 ],
		],
	 	"Termination of Programs" => [
			[ 'C', 'termination', 41189 ],
			[ 'C Integer', 'termination', 41199 ],
			[ 'Logic Programming', 'termination', 41200 ],
			[ 'Integer Transition Systems', 'termination', 41201 ],
			[ 'Integer TRS Innermost', 'termination', 41188 ],
		],
		"Complexity Analysis" => [
			[ 'Complexity: ITS', 'complexity',  ],
			[ 'Complexity: C Integer', 'complexity',  ],
			[ 'Derivational Complexity: TRS', 'complexity', 41202 ],
			[ 'Derivational Complexity: TRS Innermost', 'complexity', 41202 ],
			[ 'Derivational Complexity: TRS Innermost Certified', 'complexity',  ],
			[ 'Runtime Complexity: TRS', 'complexity', 41204 ],
			[ 'Runtime Complexity: TRS Innermost', 'complexity', 41205 ],
